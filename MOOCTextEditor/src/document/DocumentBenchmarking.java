	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			 ...
			 */  
			 ...
			 BasicDocument document = new BasicDocument(s);
			 document.getFleschScore();
			 long end = System.nanoTime();
			 System.out.print(1.0*(end-begin)/1000000000.0+"\t");
			 begin = System.nanoTime();
			 EfficientDocument document2 = new EfficientDocument(s);
			 document2.getFleschScore();
			 end = System.nanoTime();
			 System.out.println(1.0*(end-begin)/1000000000.0);
		}
